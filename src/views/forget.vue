<template>
  ...
  >
    ...
    <a-form-item has-feedback label="新密码" name="pass">
      <a-input v-model:value="formState.pass" type="password" autocomplete="off" placeholder="请输入新密码" />
    </a-form-item>
  <a-form-item has-feedback label="确认密码" name="pass">
      <a-input v-model:value="formState.pass" type="password" autocomplete="off" placeholder="确认密码" />
    </a-form-item>
    ...
    <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
      <a-button type="primary" html-type="submit" size = "middle" block = true >确认</a-button>
